    ...
    for i in range(nrows):
        for j in range(ncols):
            ...
            if j == 1:
                ...
                df.plot(ax=ax, column=col, cmap=cmap, edgecolor='#919191', 
                        norm=norm, linewidth=0.3, legend=True, 
                        legend_kwds={"shrink": 0, 'aspect':1, 'orientation':'horizontal', 
...
if __name__ == "__main__":
    ...
    path = r"F:\Research\AMFEdge\CMIP6\gpp_diff_dryseason_2015@2090.csv"
    df = pd.read_csv(path)
    ...
    cols = [('diff_mean', 'sign_prec_mean'),]*3
    grid = (1, 3)
    ...
    outpath = rf"E:\Thesis\AMFEdge\Figures\CMIP6\gpp_prj_map.jpg"
