...
if __name__ == "__main__":
    ...
    trend_path = r"F:\Research\AMFEdge\CMIP6\Predict\QDM\t2m_Edge_trend.csv"
    ...
    legend_label = ' Trend$_{T}$ (\u00B0C/decade)'
    titles = ['RCP 2.6', 'RCP 4.5', 'RCP 8.5']

    outpath = rf"E:\Thesis\AMFEdge\Figures\CMIP6\t2m_prj_trend_map.pdf"
