...
path1 = r"F:\Research\AMFEdge\Edge\Main\anoVI_Amazon_GLEAM_Edge_Effect_2023.csv"
df1 = pd.read_csv(path1)
path2 = r"F:\Research\AMFEdge\TreeCover\frag_Amazon_2023_dist95.csv"
df2 = pd.read_csv(path2)
path3 = r"F:\Research\AMFEdge\Edge\Main\anoVI_Amazon_GLEAM_Edge_2023.csv"
...
path6 = r"F:\Research\AMFEdge\Meteo\Amazon_GLEAM_Grids_2023_Meteo_stat.csv"
...
df = reduce(lambda left, right: pd.merge(left, right, on='Id', how='inner'), 
            [df1, df2, df3, df4, df5, df6, df7, df9, df11, df12])

outpath = r"F:\Research\AMFEdge\Model\Amazon_GLEAM_Edge_Attribution.csv"
