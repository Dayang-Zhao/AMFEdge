...
# grid_path = r"F:\Research\AMFEdge\Shapefile\TMF_Grids_JRC_1deg.shp"
...
# outpath = r"F:\Research\AMFEdge\Shapefile\Amazon_Grids_JRC_1deg.shp"
# filtered.to_file(outpath)

# ------------ Filter grids by TreeCover --------------
grid_path = r"F:\Research\AMFEdge\Shapefile\Amazon_Grids_JRC_1deg.shp"
grids = gpd.read_file(grid_path)
grids = grids.rename(columns={'id': 'Id'})

lcc_path = r"F:\Research\AMFEdge\Geography\Amazon_Grids_landcover_stat.csv"
...
# Save dataset.
outpath = r"F:\Research\AMFEdge\Shapefile\Amazon_Grid_Final_1deg.shp"
