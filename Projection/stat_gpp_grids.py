...
if __name__ == '__main__':
    path = r"F:\Research\AMFEdge\CMIP6\gpp_diff_dryseason_2015@2090.nc"
    ...
    for scenario in scenarios:
        ds_scenario = ds.sel(scenario=scenario)
        df = stat_grids(ds_scenario, shp, ids)
        df['scenario'] = scenario
        outdfs.append(df)
    outdf = pd.concat(outdfs, axis=0, ignore_index=True)

    # Save the output dataframe to a CSV file.
    outpath = r"F:\Research\AMFEdge\CMIP6\gpp_diff_dryseason_2015@2090.csv"
