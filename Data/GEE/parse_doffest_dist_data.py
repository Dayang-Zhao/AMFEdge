...
if __name__ == '__main__':
    ...
    root_dir = r"F:\Research\AMFEdge\EdgeOnset\metaData"
    ...
    # Parse data.
    other_columns = ['WD_mean','WD_stdDev','CWD_mean','CWD_stdDev','anoCWD_mean','anoCWD_stdDev']
    dist_columns = ['Dist',
    ...
    # dist_columns = ['Dist'] + ['rh98_'+x for x in stats] + ['rh50_'+x for x in stats]
    ...
    outpath = r"F:\Research\AMFEdge\EdgeOnset\anoVI_Amazon_UndistEdge_2023.csv"
