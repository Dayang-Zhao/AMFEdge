            ...
            if j == 1:
                df.plot(ax=ax, column=col, cmap=cmap, edgecolor='#919191', 
                        ...
                        legend_kwds={"shrink": 2.2, 'aspect':40, 'orientation':'horizontal', 
                                     'location':'bottom', 'pad':0.05,'extend':extend, 'label':r'$\Delta T$ difference (°C)'},
...
if __name__ == "__main__":
    ...
    cols = [('dtemperature_2m_mean', 'diff_sign_prec_temperature_2m_mean'),]*3
    grid = (1, 3)
    ...
    outpath = rf"E:\Thesis\AMFEdge\Figures\CMIP6\dt2m_prj_map.pdf"
