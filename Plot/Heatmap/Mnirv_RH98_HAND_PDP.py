    ...
    for i in range(nrows):
        for j in range(ncols):
            ...
            if j == 1:
                ...
                actual_ax.xaxis.set_major_locator(ticker.MaxNLocator(integer=True, nbins=4))
...
if __name__ == "__main__":
    ...
    # Plot
    grid = (1,2)
    features = [('rh98_magnitude', 'HAND_mean','nirv_magnitude', 'nirv_scale'),]*2
    ...
    outpath = r'E:\Thesis\AMFEdge\Figures\Cause\Mnirv_RH98&HAND.pdf'
