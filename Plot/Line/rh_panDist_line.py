...
def main(dfs:list, fit_dfs:list, grid:tuple, plot_setting:dict, outpath:str):
    ...
    # Adjust.
    fig.text(0.01, 0.5, r'RH98 (m)', va="center", rotation="vertical")
...
if __name__ == '__main__':
    ...
    # Fitting data.
    path = r"F:\Research\AMFEdge\EdgeRH\RH_panAmazon_Edge_effect_2023.xlsx"
    df1 = pd.read_excel(path, sheet_name='NEGRID')
    df2 = pd.read_excel(path, sheet_name='SWGRID')
    fit_dfs = [df1, df2]
    ...
    grid = (2, 1)
    outpath = r"E:\Thesis\AMFEdge\Figures\EdgeRH\pan_rh98_edge.pdf"
