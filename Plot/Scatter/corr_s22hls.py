...
if __name__ == "__main__":
    ...
    path2 = r"F:\Research\AMFEdge\EdgeHls\anoVI_Amazon_HLS_Edge_Effect_2023.csv"
    ...
    cmaps = [cmap2, cmap2]
    norms = [norm2, norm2]
    xlabels = [r'HLS $M_{\Delta \mathrm{NIRv}}$ (%)', r'HLS $S_{\Delta \mathrm{NIRv}}$ (km)']
    ylabels = [r'Sentinel-2 $M_{\Delta \mathrm{NIRv}}$ (%)', r'Sentinel-2 $S_{\Delta \mathrm{NIRv}}$ (km)']
    xlims = [(-8, 10), (0, 6.5)]
    ylims = [(-8, 10), (0, 6.5)]
    extend = ['both', 'max']
    titles = ['', '']
    ...
    outpath = r"E:\Thesis\AMFEdge\Figures\Comparison\corr_S22Hls.pdf"
