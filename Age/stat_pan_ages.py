...
if __name__ == '__main__':
    ...
    ids = {'grid':gv.NEGRID_IDS + gv.SWGRID_IDS}
    ...
    for name, id in ids.items():
        ...
        for age, group in dst_df.groupby('age'):
            outrow = {'age': age}
            for dst_var in dst_vars:
                count, mean, mstd, std = estimate_population_mean_std(group, dst_var)
    ...
    outpath = r"F:\Research\AMFEdge\EdgeAge\sumEdge\anoVI_panAmazon_dsumUndistEdge_2023_age_sum.csv"
