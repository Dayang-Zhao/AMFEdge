...
if __name__ == "__main__":
    ...
    csv_path = r"F:\Research\AMFEdge\AGB\Amazon_Grids_agcd_magnitude_stat.csv"
    mag_df = pd.read_csv(csv_path)
    csv_path = r"F:\Research\AMFEdge\AGB\Amazon_Grids_stable_agb_scale_stat.csv"
    scale_df = pd.read_csv(csv_path)
    df = mag_df.merge(scale_df, on='Id')
    df['agb_magnitude_mean'] = df['agb_magnitude_mean']

    # path = r"F:\Research\AMFEdge\AGB\EdgeAGB\AGB_Amazon_Edge_Effect_2023.csv"
    # df = pd.read_csv(path)
